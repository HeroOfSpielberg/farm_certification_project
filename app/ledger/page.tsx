...
const FARMS = [
  ...
  { id: "LA-PKS-001", name: "Ban Houay Houn Cooperative", location: "Paksong, Laos", crop: "Coffee (Typica/Catimor)", hectares: 3.8, enrolled: "2026-04", tier: "Transitioning", elevation: "1,200m",
  ...
  { id: "LA-PKS-002", name: "Farm Khamla", location: "Paksong, Laos", crop: "Coffee & Cacao (agroforestry)", hectares: 2.5, enrolled: "2026-04", tier: "Enrolled", elevation: "1,100m",
